<x-layouts.app>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2">
                <div class="card bg-base-100 shadow">
                    <figure>
                        <img src="{{ $event->gambar ? asset('images/events/' . $event->gambar) : asset('assets/images/placeholder.jpg') }}" 
                             alt="{{ $event->judul }}" 
                            ...
                            @forelse($event->tikets as $tiket)
                                <div class="card card-side shadow-sm p-4 items-center">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm mt-2 text-gray-600">{{ $tiket->keterangan ?? '' }}</p>
                                    </div>
            ...
            <aside class="lg:col-span-1">
                <div class="card sticky top-24 p-4 bg-base-100 shadow">
                    ...
                    @auth
                        <button id="checkoutButton" class="btn btn-primary !bg-blue-900 text-white btn-block mt-6" onclick="openCheckout()" disabled>
                            Checkout
                        </button>
                    @else
    ...
    <script>
        (function() {
            ...
            // Map tickets data from Blade to JS
            const tickets = {
            ...
            // Event Listeners for Inc/Dec Buttons
